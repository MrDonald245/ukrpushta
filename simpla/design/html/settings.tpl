...
<input type=hidden name="session_id" value="{$smarty.session.id}">
	...
	<div class="block layer">
		...
		<ul>
			...
			<div id="ukrposhta_legal_block" style="display: none">
			...
			<li><label for="ukrposhta_sender_tin" class=property>ИНН</label>
				<input name="ukrposhta_sender_tin" id="ukrposhta_sender_tin" class="simpla_inp"
							 type="text"
							 value="{$settings->ukrposhta_sender_tin|escape}"/></li>
		</ul>
	</div>
	{* /ukrposhta *}
