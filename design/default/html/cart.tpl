...
<ul id="deliveries">
	...
	{if $settings->ukrposhta_token && $settings->ukrposhta_bearer}
		<li>
			...
			<div class="checkbox">
				<input type="radio" name="delivery_id" value="777777" id="deliveries_ukr_post">
			</div>

			<h3>
				<label for="deliveries_ukr_post">
					Укрпочта
				</label>
			</h3>

			<div id="block_ukr_post" style="display: none;">
				<label for="ukrposhta_recipient_postcode">Почтовый индекс</label>
				<input class="simpla_small_inp" style="display: inline; width: 30%" type="text"
							 name="ukrposhta_recipient_postcode"
							 id="ukrposhta_recipient_postcode">
			</div>
		</li>
	{/if}
	{* /ukrposhta *}
